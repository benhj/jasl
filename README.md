...
longer true. Variables now scoped at the level of a given block or returnable function. 

Functions
---------

There are two types, 'blocks' and 'returnables' the former f which can be interpreted as a void function, while the
...
block myFunction () {
    ...
    // function block, the variable b will be accesseble still
    // after the loop
    repeat 5 times {
        integer 1 -> b;
    }
